...
class AndPredicateDecoderGenerator extends InstructionDecoderGenerator {
...
{{#FAILURE}}''';
  ...
  AndPredicateDecoderGenerator(MethodParseGenerator methodParseGenerator) : super(methodParseGenerator) {
