...
class OneOrMoreDecoderGenerator extends InstructionDecoderGenerator {
...
if ($_SUCCESS) {
  ...
  OneOrMoreDecoderGenerator(MethodParseGenerator methodParseGenerator) : super(methodParseGenerator) {
  ...
  List<String> generate() {
    ...
    block.assign("REPETITIONS", getLocalVariableName(_LOCAL_REPS));
