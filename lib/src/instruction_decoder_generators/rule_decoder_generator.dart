...
class RuleDecoderGenerator extends InstructionDecoderGenerator {
...
// Blank''';
  ...
  RuleDecoderGenerator(MethodParseGenerator methodParseGenerator) : super(methodParseGenerator) {
